      ...
      <div className="register-page">
        <div className="register-card success-card">
          ...
          <div className="id-display">
            <span className="id-label">Your School ID:</span>
            <span className="id-value">{success.studentId}</span>
          </div>
          <p className="info-text">Please save your School ID. You will be able to login once an admin activates your account.</p>
